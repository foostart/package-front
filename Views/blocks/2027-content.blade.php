    ...
    <div class="container">
        <div class="row events">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="thumb-27">
                    <a href="#"><img src="<?php echo $url_path ?>/images/events1.jpg" alt=""/></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="text">
                    ...
                    <div class="event-vanue">
                        <table>
                            <tbody><tr>
                                    ...
                                    <td>
                                        <p><i class="fa fa-calendar-o"></i>06 Dec, 20140 - 14 Dec, 2014</p>
                                        <p><i class="fa fa-clock-o"></i>7:30 am - 9:00 pm</p>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="text">
                    ...
                    <div class="event-vanue">
                        <table>
                            <tbody><tr>
                                <td><p class="color">Date:</p></td>
                                <td><p><i class="fa fa-calendar-o"></i>06 Dec, 20140 - 14 Dec, 2014</p>
                                    <p><i class="fa fa-clock-o"></i>7:30 am - 9:00 pm</p>
                                </td>
                            </tr>
                            <tr>
